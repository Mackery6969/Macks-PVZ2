...
HX_DEFINE_STACK_FRAME(_hx_pos_4dc5d43f2c7b5842_685_new,"flixel.ui._FlxButton.FlxButtonEvent","new",0xea40fb69,"flixel.ui._FlxButton.FlxButtonEvent.new","flixel/ui/FlxButton.hx",685,0xc64cf442)
HX_LOCAL_STACK_FRAME(_hx_pos_4dc5d43f2c7b5842_697_destroy,"flixel.ui._FlxButton.FlxButtonEvent","destroy",0x72801083,"flixel.ui._FlxButton.FlxButtonEvent.destroy","flixel/ui/FlxButton.hx",697,0xc64cf442)
HX_LOCAL_STACK_FRAME(_hx_pos_4dc5d43f2c7b5842_709_fire,"flixel.ui._FlxButton.FlxButtonEvent","fire",0x0954508d,"flixel.ui._FlxButton.FlxButtonEvent.fire","flixel/ui/FlxButton.hx",709,0xc64cf442)
namespace flixel{
namespace ui{
namespace _FlxButton{

void FlxButtonEvent_obj::__construct( ::Dynamic Callback, ::flixel::sound::FlxSound sound){
            	HX_STACKFRAME(&_hx_pos_4dc5d43f2c7b5842_685_new)
HXLINE( 686)		this->callback = Callback;
HXLINE( 689)		this->sound = sound;
            	}
...
void FlxButtonEvent_obj::destroy(){
            	HX_STACKFRAME(&_hx_pos_4dc5d43f2c7b5842_697_destroy)
HXLINE( 698)		this->callback = null();
HXLINE( 701)		this->sound = ( ( ::flixel::sound::FlxSound)(::flixel::util::FlxDestroyUtil_obj::destroy(this->sound)) );
            	}
...
void FlxButtonEvent_obj::fire(){
            	HX_STACKFRAME(&_hx_pos_4dc5d43f2c7b5842_709_fire)
HXLINE( 710)		if (::hx::IsNotNull( this->callback )) {
HXLINE( 711)			this->callback();
            		}
HXLINE( 714)		if (::hx::IsNotNull( this->sound )) {
HXLINE( 715)			this->sound->play(true,null(),null());
            		}
            	}
